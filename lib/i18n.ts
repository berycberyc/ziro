...
export const dict = {
  kk: {
    ...
    step2Desc: "Тестті, форматты (онлайн немесе офлайн) және ыңғайлы күнді таңдаңыз.",
    ...
    rankingPoint1: "Жалпы рейтинг — қатысушы коды бойынша, басқа балалардың есімдерінсіз.",
  ...
  ru: {
    ...
    step2Desc: "Выберите тест, формат (онлайн или офлайн) и удобную дату.",
    ...
    rankingPoint1: "Общий рейтинг — по коду участника, без имён других детей.",
